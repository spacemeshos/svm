...
pub use api::{
    ...
    svm_exec_receipt_returns, svm_exec_receipt_state, svm_import_func_build, svm_imports_alloc,
    svm_imports_destroy, svm_instance_context_host_get, svm_memory_kv_create,
    svm_memory_kv_destroy, svm_memory_runtime_create, svm_runtime_create, svm_runtime_destroy,
