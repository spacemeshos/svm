(module
  ...
  (import "svm" "calldata_ptr" (func $_ZN29svm_runtime_examples_calldata12calldata_ptr17h55e9019332dc0d56E (type 3)))
  (import "svm" "calldata_len" (func $_ZN29svm_runtime_examples_calldata12calldata_len17hed88dbde0c16b00eE (type 3)))
  (import "svm" "store160" (func $_ZN29svm_runtime_examples_calldata8store16017h218fc8c6c1ebcaffE (type 4)))
  (import "svm" "load160" (func $_ZN29svm_runtime_examples_calldata7load16017h8fae3a31bf709d21E (type 4)))
  (func $_ZN4core3ptr13drop_in_place17hc081dbd36e1d8bebE (type 5) (param i32))
  ...
  (func $__rust_alloc_zeroed (type 2) (param i32 i32) (result i32)
    ...
    local.get 2
    return)
  (func $_ZN15svm_abi_decoder6cursor6Cursor3new17h0e77d169fdd97301E (type 4) (param i32 i32 i32)
    local.get 0
    i32.const 0
    i32.store offset=8
    local.get 0
  ...
  (func $_ZN15svm_abi_decoder7decoder7Decoder12decode_value17hb34bcff2bed0990aE (type 4) (param i32 i32 i32)
  ...
  (func $_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$7reserve17h9af60457896686dcE (type 4) (param i32 i32 i32)
    (local i32 i32)
    block  ;; label = @1
      local.get 0
      i32.const 4
  ...
  (func $_ZN113_$LT$svm_sdk..value..Value$u20$as$u20$core..convert..From$LT$alloc..vec..Vec$LT$svm_sdk..value..Value$GT$$GT$$GT$4from17h92fee2de9c646ff8E (type 0) (param i32 i32)
    ...
    i32.load
    i32.store)
  (func $_ZN92_$LT$svm_sdk..value..Address$u20$as$u20$core..convert..From$LT$svm_sdk..value..Value$GT$$GT$4from17h964a0f3fbebd33afE (type 8) (param i32) (result i32)
    block  ;; label = @1
      block  ;; label = @2
        local.get 0
        i32.load
  ...
  (func $_ZN72_$LT$svm_sdk..value..Value$u20$as$u20$core..convert..From$LT$u64$GT$$GT$4from17h2a26227943144d2fE (type 9) (param i32 i64)
    ...
    i32.const 11
    i32.store8)
  (func $_ZN7svm_sdk6memory5alloc17hc2483383b149bf9dE (type 8) (param i32) (result i32)
    local.get 0
    i32.const 1
