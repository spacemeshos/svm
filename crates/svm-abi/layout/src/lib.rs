...
//! +---------+---------+---------------------------+
//! | 1 0 0 0 | 0 0 0 0 |  Amount - 1 byte          |
//! | 1 0 0 1 | 0 0 0 0 |  Amount - 2 bytes         |
//! | 1 0 1 0 | 0 0 0 0 |  Amount - 3 bytes         |
//! | 1 0 1 1 | 0 0 0 0 |  Amount - 4 bytes         |
//! | 1 1 0 0 | 0 0 0 0 |  Amount - 5 bytes         |
//! | 1 1 0 1 | 0 0 0 0 |  Amount - 6 bytes         |
//! | 1 1 1 0 | 0 0 0 0 |  Amount - 7 bytes         |
//! | 1 1 1 1 | 0 0 0 0 |  Amount - 8 bytes         |
//! +---------+-------------------------------------+
//! | 1 0 0 0 | 0 0 0 1 |  i8  (signed)             |
//! | 1 0 0 1 | 0 0 0 1 |  u8  (unsigned)           |
//! | 1 0 1 0 | 0 0 0 1 |  i16 (signed)   - 1 byte  |
//! | 1 0 1 1 | 0 0 0 1 |  i16 (signed)   - 2 bytes |
//! | 1 1 0 0 | 0 0 0 1 |  u16 (unsigned) - 1 byte  |
//! | 1 1 0 1 | 0 0 0 1 |  i16 (signed)   - 2 bytes |
//! | 1 1 1 0 | 0 0 0 1 |  Hash (Reserved)          |
//! | 1 1 1 1 | 0 0 0 1 |  Blob (Reserved)          |
//! +---------+---------+---------------------------+
//! | 1 0 0 0 | 0 0 1 0 |  i32 (signed)   - 1 byte  |
//! | 1 0 0 1 | 0 0 1 0 |  i32 (signed)   - 2 bytes |
//! | 1 0 1 0 | 0 0 1 0 |  i32 (signed)   - 3 bytes |
//! | 1 0 1 1 | 0 0 1 0 |  i32 (signed)   - 4 bytes |
//! | 1 1 0 0 | 0 0 1 0 |  i32 (unsigned) - 1 bytes |
//! | 1 1 0 1 | 0 0 1 0 |  i32 (unsigned) - 2 bytes |
//! | 1 1 1 0 | 0 0 1 0 |  i32 (unsigned) - 3 bytes |
//! | 1 1 1 1 | 0 0 1 0 |  i32 (unsigned) - 4 bytes |
//! +---------+---------+---------------------------+
//! | 1 0 0 0 | 0 0 1 1 |  i64 (signed)   - 1 byte  |
//! | 1 0 0 1 | 0 0 1 1 |  i64 (signed)   - 2 bytes |
//! | 1 0 1 0 | 0 0 1 1 |  i64 (signed)   - 3 bytes |
//! | 1 0 1 1 | 0 0 1 1 |  i64 (signed)   - 4 bytes |
//! | 1 1 0 0 | 0 0 1 1 |  i64 (signed)   - 5 bytes |
//! | 1 1 0 1 | 0 0 1 1 |  i64 (signed)   - 6 bytes |
//! | 1 1 1 0 | 0 0 1 1 |  i64 (signed)   - 7 bytes |
//! | 1 1 1 1 | 0 0 1 1 |  i64 (signed)   - 8 bytes |
//! +---------+---------+---------------------------+
//! | 1 0 0 0 | 0 0 1 1 |  i64 (unsigned) - 1 byte  |
//! | 1 0 0 1 | 0 0 1 1 |  i64 (unsigned) - 2 bytes |
//! | 1 0 1 0 | 0 0 1 1 |  i64 (unsigned) - 3 bytes |
//! | 1 0 1 1 | 0 0 1 1 |  i64 (unsigned) - 4 bytes |
//! | 1 1 0 0 | 0 0 1 1 |  i64 (unsigned) - 5 bytes |
//! | 1 1 0 1 | 0 0 1 1 |  i64 (unsigned) - 6 bytes |
//! | 1 1 1 0 | 0 0 1 1 |  i64 (unsigned) - 7 bytes |
//! | 1 1 1 1 | 0 0 1 1 |  i64 (unsigned) - 8 bytes |
//! +---------+---------+---------------------------+
//!
