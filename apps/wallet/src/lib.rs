...
/// +---------------------------------+
/// |  pub_key1 | pub_key2 | pub_key3 |
/// +---------------------------------+
///
/// The byte-length of each master-key is determined by function argument `key_size`.
/// So that total length of func buf is `3 * key_size`.
///
///
/// App Storage Layout
/// ==================
