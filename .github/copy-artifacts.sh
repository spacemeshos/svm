...
if [[ "${OS}" == "windows-latest" ]]; then
    ...
    cp target/aarch64-apple-darwin/release/libsvm_runtime_ffi.dylib bins/x86_64/libsvm.dylib
    cp target/aarch64-apple-darwin/release/libsvm_runtime_ffi.a bins/x86_64/libsvm.a
    cp target/aarch64-apple-darwin/release/svm-cli bins/x86_64/svm-cli
